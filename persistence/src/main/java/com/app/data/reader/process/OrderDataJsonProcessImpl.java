...
public final class OrderDataJsonProcessImpl implements OrderDataProcess {
    ...
    public OrderDataJsonProcessImpl(DataFactory<List<OrderData>, List<Order>> dataFactory) {
